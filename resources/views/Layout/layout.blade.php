    ...
    <div class="wrapper">
        <div class="main-header" data-background-color="blue">
            ...
            <div class="logo-header">
                <a href="#" class="logo">
                    <font color="white" class="navbar-brand">PETTY CASH</font>
                </a>
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item {{ request()->routeIs('show.showPettyCashFinHead') ? 'active' : '' }}">
                            <a href="{{ route('show.showPettyCashFinHead') }}">
                                <i class="fas fa-chalkboard-teacher"></i>
                                <p>Approve Dept Finance</p>
                            </a>
                        </li>
                        <li class="nav-item  {{ request()->routeIs('show.showRekapPermohonan') ? 'active' : '' }}">
                            ...
                            <div class="collapse" id="base">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{ route('show.showRekapPermohonan') }}">
                                            <span class="sub-item">Rekap Permohonan</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('show.showRekapRincian') }}">
                                            <span class="sub-item">Rekap Rincian</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
